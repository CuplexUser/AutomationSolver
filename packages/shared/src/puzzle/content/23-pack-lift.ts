...
export const packLift: PuzzleSpec = {
  ...
  briefing: [
    ...
    'on the platform and it tips the group over the wall into section 3, then lowers',
    'empty for the next one. Four flips stack 16 boxes in section 3.',
    '',
    'Keep the whole front end from the previous puzzles running — pair strokes,',
    'stroke counter, 4-pack load — and add the flip cycle:',
    '',
    '  1. When the 4-pack pusher reaches OUT (X3), the group is on the platform:',
    ...
    '     the platform — hold Y2 on and it will go as soon as the rod clears X2.',
  ...
  scenarios: [
    {
      ...
      steps: [
        ...
        {
          label: 'Flip! Four boxes land in section 3',
          holdMs: 1600,
          expect: { Y2: false },
          expectMachine: { sec3: 4, liftLoad: 0, jam: false },
        },
        { label: 'Lift back down, ready for the next group', holdMs: 700, expect: { X4: true } },
        {
          label: 'Second flip lands — eight boxes staged',
          holdMs: 2800,
    ...
    },
    {
      ...
      steps: [{ label: 'No boxes, no strokes, lift stays down', holdMs: 500, expect: { Y0: false, Y1: false, Y2: false, X4: true } }],
    },
  ],
};
