...
export const batchCounter: PuzzleSpec = {
  ...
  briefing: [
    ...
    '- C0: batch counter, preset K=5 (see Working Registers).',
    '',
  ...
  hints: [
    'Rung 1: a normally-open X0 contact drives counter C0 with preset K=5.',
  ...
  registers: [{ address: 'C0', label: 'Batch count', note: 'preset K=5, reset by X1' }],
