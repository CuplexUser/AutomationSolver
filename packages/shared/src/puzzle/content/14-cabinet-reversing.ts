...
export const cabinetReversing: PuzzleSpec = {
  ...
  briefing: [
    'The 400 V motor M1 has to run in both directions. Two contactors do it: K1 feeds',
    'the phases straight through, K2 feeds them with two phases swapped, which reverses',
    'the rotating field. Wiring both is easy; keeping them from ever closing together',
    'is the work order.',
    '',
    '## Equipment',
    '- K1 FORWARD and K2 REVERSE contactors: mains 1-2, 3-4, 5-6; coil A1-A2;',
    '  auxiliaries 13-14 (NO) and 21-22 (NC).',
    '- S1 FORWARD (NO), S2 REVERSE (NO), S3 STOP (NC).',
    '- M1 MOTOR: terminals U, V, W.',
    '',
    '## Power circuit',
    '1. Forward: L1 to K1.1, L2 to K1.3, L3 to K1.5, then K1.2, K1.4 and K1.6 to U, V',
    '   and W.',
    '2. Reverse: feed K2 with two phases swapped, for example L3 to K2.1, L2 to K2.3,',
    '   L1 to K2.5.',
    '3. Land K2.2, K2.4 and K2.6 on the same U, V and W motor terminals.',
    '',
    '## Control circuit',
    '1. Start both rungs from L1 through the STOP contact S3 (21-22), then split to the',
    '   two direction buttons.',
    '2. Forward rung: S1 (13-14), then the reverse contactor\'s NC auxiliary K2 21-22,',
    '   then the coil K1.A1-A2 to N.',
    '3. Reverse rung: S2 (13-14), then K1 21-22, then the coil K2.A1-A2 to N.',
    '4. Seal each direction across its own start button with its own auxiliary 13-14.',
    '',
    '## Safety rules',
    '- K1 and K2 closing together shorts phase to phase. The cross interlock through',
    '  each other\'s NC auxiliary is what prevents it.',
    '- Pressing REVERSE while the motor runs forward must do nothing at all. The',
    '  operator has to press STOP first.',
  ].join('\n'),
  hints: [
