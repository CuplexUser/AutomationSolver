...
export const delayedStart: PuzzleSpec = {
  ...
  briefing: [
    'A conveyor in a busy aisle has to warn anyone standing near it before it moves.',
    'Commission the two-stage start: beacon first, belt two seconds later.',
    '',
    '## Equipment',
    '- X0 START and X1 STOP: momentary push buttons.',
    '- Y1 WARNING BEACON: amber beacon over the drive end.',
    '- Y0 MOTOR: the conveyor drive.',
    '- M0 and T0: run latch and on-delay timer (see Working Registers).',
    '',
    '## Sequence of operation',
    '1. Press START. The run command seals in and the beacon Y1 lights at once.',
    '2. The timer T0 starts counting along with the beacon.',
    '3. After 2.0 seconds the motor Y0 starts. The beacon stays lit while it runs.',
