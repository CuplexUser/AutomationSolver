...
export const twoHandPress: PuzzleSpec = {
  ...
  briefing: [
    ...
    'may advance only while BOTH palm buttons (LEFT X0 and RIGHT X1) are held and',
    'the E-STOP (X2) is healthy. Let go of either palm and the ram retracts at once.',
    '',
    ...
    'and pressed afresh.',
    '',
    'BOTTOM (X3) is a field sensor driven by the press, so you cannot press it. The',
    'E-STOP is wired normally-closed, so it reads ON while healthy.',
    '',
    'Tip: one mouse cannot hold two buttons, so hold the number keys shown on the',
