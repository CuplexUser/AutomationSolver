...
export const cabinetReversingProtected: PuzzleSpec = {
  ...
  briefing: [
    ...
    'everything a real one does: two contactors, a shared overload, an emergency stop',
    'and three pilot lights.',
    '',
    '## Equipment',
    '- K1 FORWARD and K2 REVERSE contactors, and F1 THERMAL OVERLOAD.',
    '- S0 EMERGENCY STOP (NC), S3 STOP (NC), S1 FORWARD (NO), S2 REVERSE (NO).',
    '- H1 FORWARD (green), H2 REVERSE (blue), H3 TRIP (red).',
    '',
    '## Power circuit',
    '1. Forward: L1 to K1.1, L2 to K1.3, L3 to K1.5. Reverse: two phases swapped into',
    '   K2, for example L3 to K2.1, L2 to K2.3, L1 to K2.5.',
    '2. Join both contactor outputs onto the same overload inputs (K1.2 and K2.2 to',
    '   F1.1, and so on), so one overload protects both directions.',
    '3. F1.2 to U, F1.4 to V, F1.6 to W.',
    '',
    '## Control circuit',
    '1. Build the common feed first: L1 through the E-Stop S0 (21-22), the overload',
    '   contact F1 95-96, and the STOP button S3 (21-22).',
    '2. Split that feed to the two start buttons, S1.13 and S2.13.',
    '3. Forward rung: S1.14 to K2 21-22 (the interlock), then K1.A1-A2 to N, sealed by',
    '   K1 13-14 across S1.',
    '4. Reverse rung: mirror it through K1 21-22 into K2.A1-A2, sealed by K2 13-14',
    '   across S2.',
    '',
    '## Indication',
    '- H1 in parallel with the K1 coil and H2 in parallel with the K2 coil (X1 to A1,',
    '  X2 to A2).',
    '- H3 on its own rung: L1 through F1 97-98 to H3.X1, and H3.X2 to N, so the trip',
    '  shows whatever else is going on.',
    '',
    '## Safety rules',
    '- The E-Stop and the overload belong in the common feed, never in one direction\'s',
    '  rung. Both directions have to drop out.',
    '- The cross interlock between the coils is what stops K1 and K2 closing together',
    '  and shorting phase to phase.',
  ].join('\n'),
  hints: [
